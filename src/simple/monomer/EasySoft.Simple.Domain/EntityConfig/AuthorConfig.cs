...
namespace EasySoft.Simple.Domain.EntityConfig;
...
public class AuthorConfig : BaseEntityTypeConfiguration<Author>
{
    public override void Configure(EntityTypeBuilder<Author> builder)
    {
        ...
        builder.Property<Author>(x => x.CustomerId);
        ...
        builder.OwnsOne(x => x.Status, y =>
        {
            ...
            y.Property(z => z.ChangesReason).HasColumnName("statuschangesreason")
                .HasMaxLength(OrdConsts.ChangesReason_MaxLength);
        });
