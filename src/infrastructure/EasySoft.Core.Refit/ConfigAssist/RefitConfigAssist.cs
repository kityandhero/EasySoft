...
/// SwaggerConfigAssist
/// </summary>
public static class RefitConfigAssist
{
    private static readonly string ConfigFile = $"{nameof(RefitConfig).ToLowerFirst()}.json";

    private static readonly string FilePath;

    private static IConfiguration Configuration { get; set; }

    static RefitConfigAssist()
    {
        var directory = Tools.GetConfigureDirectory();

        FilePath = $"{directory}{nameof(RefitConfig).ToLowerFirst()}.json";
        ...
        Configuration.Bind(RefitConfig.Instance);
    }
    ...
    public static void Init()
    {
        StartupDescriptionMessageAssist.AddExecute(
            $"{nameof(RefitConfigAssist)}.{nameof(Init)}."
        );
    }
    ...
    private static RefitConfig GetConfig()
    {
        return RefitConfig.Instance;
    }
