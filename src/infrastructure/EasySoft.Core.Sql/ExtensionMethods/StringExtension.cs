...
public static class StringExtension
{
    ...
    public static string From<T>(this string sql) where T : IEntityExtra, new()
    {
        return SqlAssist.From(sql, new T());
    }

    public static string From<T>(this string sql, T model) where T : IEntityExtra
    {
    ...
    public static string InnerJoin<T>(this string sql) where T : IEntityExtra, new()
    {
        return SqlAssist.InnerJoin<T>(sql);
    }

    public static string InnerJoin<T>(this string sql, T model) where T : IEntityExtra
    {
        return SqlAssist.InnerJoin(sql, model);
    }

    public static string LeftJoin<T>(this string sql) where T : IEntityExtra, new()
    {
        return SqlAssist.LeftJoin<T>(sql);
    }

    public static string LeftJoin<T>(this string sql, T model) where T : IEntityExtra
    {
    ...
    public static string And<T>(this string sql, Condition<T> condition) where T : IEntityExtra, new()
    {
    ...
    public static string WhereCondition<T>(this string sql, Condition<T> condition) where T : IEntityExtra, new()
    {
        return SqlAssist.WhereCondition(sql, condition);
    }

    public static string AndCondition<T>(this string sql, Condition<T> condition) where T : IEntityExtra, new()
    {
    ...
    public static string LinkCondition<T>(this string sql, Condition<T> condition) where T : IEntityExtra, new()
    {
