...
namespace EasySoft.Core.Sql.Assist
{
    public static class SqlAssist
    {
        ...
        public static string AllField(string sql, params IEntity[] models)
        {
        ...
        public static string From<T>(string sql, T model) where T : IEntity
        {
        ...
        public static string InnerJoin<T>(string sql) where T : IEntity, new()
        {
            var model = new T();
        ...
        public static string LeftJoin<T>(string sql) where T : IEntity, new()
        {
            var model = new T();
        ...
        public static string And<T>(string sql, Condition<T> condition) where T : IEntity, new()
        {
        ...
        ) where T : IEntity, new()
        {
            ...
            {
                result = LinkCondition(result, condition);
            }
        ...
        ) where T : IEntity, new()
        {
            ...
            {
                connector = GetConditionConnector(sql);
            }
        ...
        ) where T : IEntity, new()
        {
            ...
            foreach (var assignUpdate in assignUpdates)
            {
                result = LinkAssignField(result, assignUpdate);
            }
        ...
        ) where T : IEntity, new()
        {
            ...
            {
                fieldList.Add(TransferAssist.TransferField(fieldItem));
            }
        ...
        public static string Insert(IEntity model)
        {
            ...
            if (!string.IsNullOrWhiteSpace(nameString.ToString()))
            {
