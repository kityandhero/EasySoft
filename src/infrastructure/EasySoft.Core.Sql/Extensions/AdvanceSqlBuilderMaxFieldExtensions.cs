...
/// <summary>
/// AdvanceSqlBuilderMaxFieldExtensions
/// </summary>
public static class AdvanceSqlBuilderMaxFieldExtensions
{
    /// <summary>
    /// MaxField
    /// </summary>
    ...
    /// <returns></returns>
    public static AdvanceSqlBuilder MaxField<T>(
    ...
    )
    {
        ...
        return builder.MaxField(fieldItem);
    }
    ...
    )
    {
        ...
        return builder.MaxField(sqlField);
    }
