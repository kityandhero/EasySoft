...
public static class WebApplicationBuilderExtensions
{
    ...
    {
        // if (GeneralConfigAssist.GetSkyApmSwitch()) SkyApm.AddCap();

        // builder.Services.AddCapEventBus<TSubscriber>(option =>
        // {
        ...
        //             option.ConnectionFactoryOptions = (facotry) => { facotry.ClientProvidedName = serviceInfo.Id; };
        //         });
        //     }
        //
        //     var serviceInfo = builder.Services.GetServiceInfo();
        //
