...
namespace UtilityTools
{
    ...
    public static class ConstCollection
    {
        ...
        public static readonly DateTime ProductRankingWeightBeginTime = new DateTime(2019, 1, 1, 0, 0, 0);
        public const long ProductRankingWeightBeginUnixTime = 1546272000;

        public static readonly DateTime UserCouponRankingWeightBeginTime = new DateTime(2020, 1, 1, 0, 0, 0);
        ...
        public const char IdentificationCodeSpliter = '|';
        ...
        public static readonly DateTime DateTimeDefault = new DateTime(2010, 1, 1, 0, 0, 0);
