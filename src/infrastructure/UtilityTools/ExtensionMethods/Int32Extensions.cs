...
namespace UtilityTools.ExtensionMethods
{
    public static class Int32Extensions
    {
        ...
        public static object ToObject(this int v) => v;
        ...
        public static string GetEnumDescription<T>(this int v) where T : struct
        {
            ...
            var descriptionAttribute = fieldInfo.GetAttribute<DescriptionAttribute>(
                "",
                false,
                MemberTypes.Field
            );
        ...
        public static string GetRenderValuer<T>(this int v) where T : struct
        {
            ...
            var renderValueAttribute = fieldInfo.GetAttribute<RenderValueAttribute>(
                "",
                false,
                MemberTypes.Field
            );
            ...
            {
                result = renderValueAttribute.Description;
            }
        ...
        public static bool CheckInEnumWithExclude<T>(this int v, params T[] excludeItems) where T : struct
        {
            ...
            {
                throw new Exception("参数缺失，需要指定检测的排除项目");
            }
