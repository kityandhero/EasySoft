...
public abstract class ExcelBase : IExcel
{
    ...
    {
        _sheet = sheetName.IsNullOrEmpty() ? _workbook?.CreateSheet() : _workbook?.CreateSheet(sheetName);
    ...
    private void SetCellValue(object value)
    {
        switch (value.GetType().ToString())
        {
            ...
            case "System.DateTime":
                ...
                break;
            case "System.Boolean":
                _cell?.SetCellValue(ConvertAssist.ToBool(value));
                break;
            case "System.Byte":
            case "System.Int16":
            case "System.Int32":
            case "System.Int64":
                _cell?.SetCellValue(ConvertAssist.ToInt(value));
                break;
            case "System.Double":
            case "System.Decimal":
