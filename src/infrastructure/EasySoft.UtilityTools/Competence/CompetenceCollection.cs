...
namespace EasySoft.UtilityTools.Competence
{
    public sealed class CompetenceCollection
    {
        ...
        {
            if (competenceSets.IsNullOrEmpty())
            {
                return;
            }
            ...
            if (remove)
            {
                CompetenceSets.Remove(removeVal);
            }
        ...
        private class CompetenceSingleton
        {
            ...
            internal static readonly CompetenceCollection SET = new CompetenceCollection();
        }
    }
}