...
namespace EasySoft.UtilityTools
{
    ...
    public class ChineseCalendar
    {
        ...
        private string GetChineseHour(DateTime dt)
        {
            ...
            string tmpGan = Gan.Substring(indexGan) + Gan.Substring(0, indexGan + 2);
        ...
        public string ChineseYearString
        {
            ...
            {
                string tempStr = "";
                string num = _cYear.ToString(CultureInfo.InvariantCulture);
                for (int i = 0; i < 4; i++)
                {
        ...
        public string GanZhiYear
        {
            get
            {
                ...
                string tempStr = Gan[i % 10].ToString(CultureInfo.InvariantCulture) +
        ...
        public string GanZhiMonth
        {
            get
            {
                ...
                string zhi = Zhi[zhiIndex - 1].ToString(CultureInfo.InvariantCulture);
                ...
                string gan = Gan[(ganIndex + _cMonth - 2) % 10].ToString(CultureInfo.InvariantCulture);
        ...
        {
            get { return GanZhiYear + GanZhiMonth + GanZhiDay; }
        }
