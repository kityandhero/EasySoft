...
using UtilityTools.Entity;
using UtilityTools.Enums;
using UtilityTools.Exceptions;
...
namespace Framework.ExtensionMethods
{
    ...
    public static class ControllerExtensions
    {
        ...
        )
        {
            ...
            var value = GetParamValue(c, param);
        ...
        ) where T : struct
        {
            ...
            var input = GetParamValue(c, param);
        ...
        {
            var names = c.GetAllParamNames();

            return names.Contains(name);
        }

        private static string GetParamValue(ControllerBase c, string param)
        {
            var request = c.Request;
